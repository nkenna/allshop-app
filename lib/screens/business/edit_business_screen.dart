import 'package:ems/models/business.dart' as b;
...
class EditBusinessScreen extends StatefulWidget {
  final b.Business? business;
  const EditBusinessScreen({Key? key, this.business}) : super(key: key);
...
class _EditBusinessScreenState extends State<EditBusinessScreen> {
    ...
    .then((value) {
      if(value != null){
        ...
        for(var i = 0; i < _categories!.length; i++){
          if(widget.business!.category!.sId == _categories![i].id){
  ...
  detailController.text = widget.business!.detail ?? '';
  addressController.text = widget.business!.address ?? '';
  contactPhoneController.text = widget.business!.contactPhone ?? '';
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async{
          ...
          final resp = await Provider.of<BusinessProvider>(context, listen: false).editBusinessRequest(
            nameController.text,
            detailController.text,
            widget.business!.plazaId,
